...
<div id="topnav">
  ...
  <a href="signup.php" align="right">Sign in</a>
</div>

<?php require('SQLFiles/SQLPublish.php');$search = $_POST['animesearch']; echo $search; var_dump(publisher(array('type' => 'searchAnime', 'title' => $search)));?>

<script>
  /*
    	let input = '<?php //publisher(array('type' => 'searchAnime', 'title' => $search))); ?>';
